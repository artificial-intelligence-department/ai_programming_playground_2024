...
FileOpResult copy_file(const char *file_from, const char *file_to)
{
    ...
    if(!fto.is_open())
    {
        cerr << "Error: unable to open the file 'to'" << "\n";
        return Failure;
    }

    if(!ffrom.is_open())
    {
        cerr << "Error: unable to open the file 'from'" << "\n";
        return Failure;
    } 
...
{   
    ...
    const char *FileName1 = "C:/Users/ivank/ai_programming_playground_2024/ai_12/ivanna_smachylo/epic_5/file_from.txt";
    const char *FileName2 = "C:/Users/ivank/ai_programming_playground_2024/ai_12/ivanna_smachylo/epic_5/file_to.txt";
    ...
    cout << "Execution status of the task 1 : " << write_to_file(FileName1, content) << "\n";
