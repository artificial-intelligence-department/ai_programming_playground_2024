...
void create_matrixD(int rowD, int colD, int matrixD[5][5]){
...
void print_matrixD(int rowD, int colD, int matrixD[5][5]){
    for(int i = 0; i < rowD; ++i){
        for(int j = 0; j < colD; ++j){                     // Заповнення двовимірного статичного масиву
...
void determinat_for_matrix_DETERMINATOR(int rowD, int colD, int matrixD[5][5]){
